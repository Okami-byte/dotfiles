...
local palettes = {
	["rose_pine"] = {
		bar = {
			background = function(tpf, f)
				return f(0x161616, 145)
			end,
			border = function(tpf, f)
				return f(0x808080, tpf - 20)
			end,
		},
		text = {
			primary = 0xffe0def4,
		...
		zone = {
			background = function(tpf, f)
				return f(0x393552, tpf - 50)
			end,
			border = function(tpf, f)
				return f(0x44415a, tpf - 20)
			end,
			overlay = 0xff56526e,
		},
		colors = {
	...
	["catppuccin_latte"] = {
		bar = {
			background = function(tpf, f)
				return f(0xcdd0da, tpf - 80)
			end,
			border = function(tpf, f)
				return f(0xbcc0cc, tpf - 40)
			end,
		},
		text = {
			primary = 0xff4c4f69,
		...
		zone = {
			background = function(tpf, f)
				return f(0xbcc0cc, tpf - 80)
			end,
			border = function(tpf, f)
				return f(0xcdd0da, tpf - 40)
			end,
			overlay = 0xffacb0be,
		},
		colors = {
	...
	["catppuccin_frappe"] = {
		bar = {
			background = function(tpf, f)
				return f(0x414559, tpf)
			end,
			border = function(tpf, f)
				return f(0x51576d, tpf)
			end,
		},
		text = {
			primary = 0xffc6d0f5,
		...
		zone = {
			background = function(tpf, f)
				return f(0x51576d, tpf - 50)
			end,
			border = function(tpf, f)
				return f(0x414559, tpf - 20)
			end,
			overlay = 0xff626880,
		},
		colors = {
	...
	["kanagawa"] = {
		bar = {
			background = function(tpf, f)
				return f(0x363646, tpf)
			end,
			border = function(tpf, f)
				return f(0x585873, tpf)
			end,
		},
		text = {
			primary = 0xffd5d0ba,
		...
		zone = {
			background = function(tpf, f)
				return f(0x585873, tpf - 50)
			end,
			border = function(tpf, f)
				return f(0x363646, tpf - 20)
			end,
			overlay = 0xff414156,
		},
		colors = {
	...
	["tokyo_night"] = {
		bar = {
			background = function(tpf, f)
				return f(0x292e42, tpf)
			end,
			border = function(tpf, f)
				return f(0x414868, tpf)
			end,
		},
		text = {
			primary = 0xffc0caf5,
		...
		zone = {
			background = function(tpf, f)
				return f(0x414868, tpf - 50)
			end,
			border = function(tpf, f)
				return f(0x292e42, tpf - 20)
			end,
			overlay = 0xff3b4261,
		},
		colors = {
	...
	["solarized_osaka"] = {
		bar = {
			background = function(tpf, f)
				return f(0x073642, tpf)
			end,
			border = function(tpf, f)
				return f(0x586e75, tpf)
			end,
		},
		text = {
			primary = 0xffeee8d5,
		...
		zone = {
			background = function(tpf, f)
				return f(0x586e75, tpf - 50)
			end,
			border = function(tpf, f)
				return f(0x073642, tpf - 20)
			end,
			overlay = 0xff0f3b47,
		},
		colors = {
