...
This is a config I made which aggregate functionality and aesthetics, made in mind to be Nix-Compliant.

See https://github.com/FelixKratz/SketchyBar/discussions/47#discussioncomment-14058252

> [!WARNING] 
> Some of the functionalities of the bar are not working currently in MacOS Tahoe (26.0).
> Permissions issues and other not yet tested bugs might occur.
> 
> Since this was a personal config not meant for release, the original code that remains is garbage... sorry 😅
